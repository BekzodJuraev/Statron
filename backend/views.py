        ...
        if message_text == '/start':
            ...
            if message_text in chanel_link:
                ...
                text = (
                    ...
                    f"👆Выше Вы сможете просмотреть подробную аналитику за запрашиваемый канал / Спасибо за запрос ❤"
                )
    ...
    def get_context_data(self, *, object_list=None, **kwargs):
        ...
        if get_language() == 'en':
            try:
                ...
                url = f"https://pay.freekassa.net/?m={SHOP_ID}&oa={amount}&o={id_order}&s={signature}&currency={CUR}&us_key={self.request.user.username}"
