    ...
    (() => {
        ...
        class SelectConstructor {
            ...
            getSelectTitleValue(selectItem, originalSelect) {
                ...
                if (originalSelect.hasAttribute("data-search")) return `<div class="_icon-arrow-down ${this.selectClasses.classSelectTitle}"><span${pseudoAttribute} class="${this.selectClasses.classSelectValue}"><img src="img/icons/arrow-down.svg" alt=""><input autocomplete="off" type="text" placeholder="${selectTitleValue}" data-placeholder="${selectTitleValue}" class="${this.selectClasses.classSelectInput}"></span></div>`; else {
                    const customClass = this.getSelectedOptionsData(originalSelect).elements.length && this.getSelectedOptionsData(originalSelect).elements[0].dataset.class ? ` ${this.getSelectedOptionsData(originalSelect).elements[0].dataset.class}` : "";
                    return `<button type="button" class="_icon-arrow-down ${this.selectClasses.classSelectTitle}"><img src="img/icons/arrow-down.svg" alt=""><span${pseudoAttribute} class="${this.selectClasses.classSelectValue}${pseudoAttributeClass}"><span class="${this.selectClasses.classSelectContent}${customClass}">${selectTitleValue}</span></span></button>`;
                }
            }
        ...
        if (document.querySelector("[data-datepicker]")) {
            ...
            pickers.forEach(((item, i) => {
                item.setAttribute(`data-datepicker-${i}`, "true");
            }));
            pickers.forEach(((item, i) => {
